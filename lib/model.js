...
function addIndex (criteria, id, index, cb) {
  map(criteria.device, function iterator (device, index, callback) {
...
function addHour (criteria, id, index, cb) {
  map(criteria.hour, function iterator (hour, index, callback) {
...
function addDay (criteria, id, index, cb) {
  map(criteria.day, function iterator (day, index, callback) {
...
function addState (criteria, id, index, cb) {
  map(criteria.state, function iterator (state, index, callback) {
